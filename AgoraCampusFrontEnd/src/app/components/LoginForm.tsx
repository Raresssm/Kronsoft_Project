...
export function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto rounded-[1.75rem] border border-white/20 bg-white/5 p-6 shadow-2xl backdrop-blur-xl sm:p-8">
      ...
      <h1 className="text-center text-xl font-light tracking-[0.2em] text-white/90">SIGN IN</h1>
      ...
      <form className="mt-8 space-y-5" onSubmit={(event) => void handleSubmit(event)}>
        ...
        {(error || authError) && <p className="text-center text-xs text-red-400">{error || authError}</p>}
